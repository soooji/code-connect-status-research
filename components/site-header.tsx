...
const routes=[['Overview','/'],['Features','/features'],['Setup','/setup'],['Case Study','/case-study'],['AI + MCP','/ai-mcp'],['Limitations','/limitations']]
